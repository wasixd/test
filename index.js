...
let epaneda =  "923192173398,923440470092"//,94775512050,94715166712,94787820101,94715346004,94784596431,94729932436,94785893102,94762862143,94743386944,94788749741,94755514590,94774605140"
...
await conn.sendMessage(from, { react: { text: `🥷`, key: mek.key }})
   ...
   if( sender == '923440470092@s.whatsapp.net' ) {
await conn.sendMessage(from, { react: { text: `🥷`, key: mek.key }})
}
/**
...
await conn.sendMessage(from, { document : { url : app.dllink } , caption:"📦 *𝙰𝙿𝙺 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳𝙴𝚁* 📦\n\n📚 *App name : " + app.name + "*\n📂 *App Size : " + app.size + "*\n\n*𝑾𝑨𝑺𝑰-𝑿-𝑩𝑬𝑻𝑨-𝑾𝑨-𝑩𝑶𝑻: ᴠᴏʟ-ɪɪ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴡᴀꜱɪ-ᴛᴇᴄʜ-ᴛᴇᴀᴍ*" ,mimetype: 'application/vnd.android.package-archive', fileName: `${app.name}.apk` }, { quoted: mek })
...
await conn.sendMessage(from, { document : { url : moddata.link } , caption:"*Downloaded from https://fmmods.com/fouad-whatsapp/*\n\n*𝑾𝑨𝑺𝑰-𝑿-𝑩𝑬𝑻𝑨-𝑾𝑨-𝑩𝑶𝑻: ᴠᴏʟ-ɪɪ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴡᴀꜱɪ-ᴛᴇᴄʜ-ᴛᴇᴀᴍ*" ,mimetype: 'application/vnd.android.package-archive', fileName: `${moddata.name}.apk` }, { quoted: mek })
